...
[OnlineWithAuthentication identity](../concepts/designing-permissions), or by the
...
- App ID
- Provider name
- Credentials to be forwarded to the app's [authentication webhook](../security/authentication)
