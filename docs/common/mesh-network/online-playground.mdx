...
[Online With Authentication](../security/authentication).
:::
...
must re-connect to the Internet to get a new certificate. 

This one week expiration is a setting that you can customize. Use
[OnlineWithAuthentication](../security/authentication) if a device needs to
be offline for more or less than one week.
