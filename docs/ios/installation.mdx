...
:::caution
Our Objective-C SDK, `DittoObjC`, has been deprecated as of March 1st, 2023.
`DittoSwift` is our sole SDK for Apple platforms going forward. If an
Objective-C SDK is a hard requirement for you,
[please let us know](https://www.ditto.live/about/contact).
:::
